...
@dp.callback_query_handler(state = UserState.flashcard.get_book_num)
async def get_book_num_calback_flashcard(query : types.CallbackQuery, state : FSMContext):
